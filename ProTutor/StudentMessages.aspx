<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentMessages.aspx.cs" Inherits="ProTutor.StudentMessages" %>
    ...
    <div class="container">
        <div class="row">
            <asp:Repeater ID="rptMessages" runat="server">
                ...
                <ItemTemplate>
                    <div class="<%#((string) Eval("Direction")) == "StudentToTutor" ? "out" : "in"%>">
        ...
        <div class="message">
            ...
            <a href="StudentConversations.aspx">
