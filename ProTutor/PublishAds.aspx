<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PublishAds.aspx.cs" Inherits="ProTutor.PublishAds" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div class="container text-center testimonials">
        <h1 class="text-center">Publish Your Advertisement</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <asp:Button ID="btnPublish" runat="server" Text="Publish" class="btn btn-primary btn-block" OnClick="btnPublish_Click" />
                </div>
            </div>
            <div class="col-md-4"></div>
        </div>
